...
function RespondLater({navigation}){
  ...
  console.log('data save')
    ...
    function NotificationHandler({ item }) {
      return (
        ...
        <View style={{flexDirection:'row'}}>
        <Pressable style={styles.NotifyUserContainer} onPress={SaveDataHandler}>
            <Text
              style={{
                color: "#000000",
                paddingLeft: 30,
          ...
          <Pressable style={styles.RepondLaterContainer} onPress={CancelResponse}>
            <Text
              style={{
                color: "#ffffff",
                paddingLeft: 50,
