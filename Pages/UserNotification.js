...
function UserNotification({navigation}){
  ...
  function HomePageHandler(){
          ...
          headerRight: () => {
            return (
              <View style={styles.iconsConatiner}>
                <FilterIcon onPress={DropdownHandler}></FilterIcon>
              </View>
            );
          },
            headerLeft: () => {
        ...
        function AddTokartHandler(){
          return(
            Alert.alert('Added to Kart!!!')
          )
        }
        ...
        function NotificationHandler({item}){
          return(
            <View style={styles.ItemContainer}>
             ...
             <Pressable style={styles.AddToKartContainer} onPress={AddTokartHandler}>
              <Text style={{color:'#000000', paddingLeft:30, paddingTop:8, fontWeight:'600'}}>Add To Kart</Text>
             </Pressable>
            </View>
          )
        }
